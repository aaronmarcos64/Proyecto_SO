...
namespace InicioPartida
{
    public partial class Form2 : Form
    {
        ...
        private void seleccionarficha_Click(object sender, EventArgs e)
        {
            ...
            dado1 = Convert.ToInt32(txtbox_dado1.Text);
            dado2 = Convert.ToInt32(txtbox_dado2.Text);
            ...
            if (elegir == 0)
            {
                ...
                if (found == 1)
                {
                    if (i == 0) { ficha_Verde[dado1-1] = ficha_Verde[dado1-1] + dado[0]; ficha_Verde[dado2-1] = ficha_Verde[dado2 - 1] + dado[2]; }
                    if (i == 1) { ficha_Roja[dado1 - 1] = ficha_Roja[dado1 - 1] + dado[0]; ficha_Roja[dado2 - 1] = ficha_Roja[dado2 - 1] + dado[2]; }
                    if (i == 2) { ficha_Azul[dado1 - 1] = ficha_Azul[dado1 - 1] + dado[0]; ficha_Azul[dado2 - 1] = ficha_Azul[dado2 - 1] + dado[2]; }
                    if (i == 3) { ficha_Amarilla[dado1 - 1] = ficha_Amarilla[dado1 - 1] + dado[0]; ficha_Amarilla[dado2 - 1] = ficha_Amarilla[dado2 - 1] + dado[2]; }
                    Actualizar_fichas();
                }
            }
        }
